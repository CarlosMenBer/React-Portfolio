...
const Data = () => {
  return (
    <div className='home__data'>
        <h1 className='home__title'>Carlos Mendoza
        ...
        <h3 className="home__subtitle"> Desarrollador de aplicaciones multiplataforma</h3>
        <p className='home__descripcion'> Soy un desarrollador de aplicaciones en Madrid, manejo distinos idiomas tanto en back-end como en front-end</p>
